	...
	$R.setOptions = function ()
	{
		...
		if (_resetBase)
		{
			...
			//	append
			    ...
			    $('head').append('<link id="baseCSS" rel="stylesheet" href="'+$R.path+'base-'+_applyOptions['base']+'.css?t='+$R.compileTime+'" type="text/css" />');
                        }
		}
...
// WARNING: Will need to remove fonts which don't have 400 / regular variants, 
// or just properly update the font parsing / css generation to handle odd weights.
